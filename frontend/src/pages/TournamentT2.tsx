...
const TournamentT1 = () => {
  ...
  const [newMatches, setNewMatches] = useState<Match[]>([
    // Ces matchs pourraient être générés à partir des gagnants,
    // ici on les initialise par exemple à vide (ou avec des placeholders)
    { id: 3 },
    { id: 4 },
  ]);
  ...
  const renderMatch = (match: Match) => (
    <div key={match.id} className="bg-white p-6 rounded-lg shadow-lg w-72 z-10 relative text-lg">
  ...
  return (
    <div key={resetKey} className="min-h-screen bg-gray-50 p-8">
      <div className="flex flex-col gap-16">
        ...
        {/* Espace important entre les groupes */}
        <div className="mt-16">
          <h2 className="text-lg font-semibold text-center mb-8">
            Finales
          </h2>
